...
function displayTaskDone () {
  ...
  for (var i = 0; i < numberOfTasks; i++) {
      ...
      if (!task.checked) {
          ...
          elementToDisplay.style.animation = "slideUp 2s forwards"
      }
      else{
        let elementToDisplay = task.parentElement.parentElement
        elementToDisplay.style.animation = "slideDown 2s forwards"
...
function displayAllTasks () {
  ...
  for (var i = 0; i < numberOfTasks; i++) {
      ...
      elementToDisplay.style.animation = "slideDown 1s forwards"
  }
...
function displayUndoneTasks () {
  ...
  for (var i = 0; i < numberOfTasks; i++) {
      ...
      if (task.checked) {
          let elementToDisplay = task.parentElement.parentElement
          elementToDisplay.style.animation = "slideUp 1s forwards"
      }
      else {
        let elementToDisplay = task.parentElement.parentElement
        elementToDisplay.style.animation = "slideDown 2s forwards"
